...
const precoRefrigerante = 12.99 * 3
...
let total = parseInt(precoVinho + precoFeijao + precoArroz + precoErvilha + precoMacarrao + precoRefrigerante)
...
let valorRefrigerante = parseInt(prompt("Digite o preço do refrigerante"))
let quantidadeRefrigerante = parseInt(prompt("Digite a quantidade de refrigerante"))

let valorMacarrao = parseInt(prompt("Digite o preço do macarrão"))
let quantidadeMacarrao = parseInt(prompt("Digite a quantidade de macarrão"))

let valorErvilha = parseInt(prompt("Digite o preço da ervilha"))
let quantidadeErvilha = parseInt(prompt("Digite a quantidade de ervilha"))

let valorArroz = parseInt(prompt("Digite o preço do arroz"))
let quantidadeArroz = parseInt(prompt("Digite a quantidade de arroz"))

let valorFeijao = parseInt(prompt("Digite o preço do feijão"))
let quantidadeFeijao = parseInt(prompt("Digite a quantidade de feijão"))

let valorVinho = parseInt(prompt("Digite o preço do vinho"))
...
let totalDasCompras = totalRefrigerante + totalMacarrao + totalErvilha + totalArroz + totalFeijao + totalMacarrao
